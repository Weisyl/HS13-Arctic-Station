...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("wooden wall", /obj/structure/woodenwall, 30, time = 60, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wooden window frame", /obj/structure/barricade/window/windowless, 5, time = 30, one_per_turf = 1, on_floor = 1), \
